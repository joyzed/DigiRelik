readme.txt – v1a.0.0.1 – 24/05/2025 20:00:00
------------------------------------------------------------

Ajouts de la version :
- structure.json : structure logique du site
- hexekta.html : galerie des artefacts NFT
- art.html : page de détail d’un artefact
- labs.html : présentation des collections NFT
- mint.html : mint d’un artefact (fonctionnalité en pause)
- trade.html : gestion d’échange crypto
- roadmap.html : feuille de route
- faq.html : questions fréquentes
- news.html : actualités du projet
